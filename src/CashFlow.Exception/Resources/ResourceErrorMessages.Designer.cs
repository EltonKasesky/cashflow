...
namespace CashFlow.Exception.Resources {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The expense cannot be found..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The password must be have one number, one case up letter, one case down letter and one special character (?, !, /, *)..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The password must be greater than eight characters..
        /// </summary>
        public static string PASSWORD_MUST_BE_GREATER_THAN_EIGHT {
            get {
                return ResourceManager.GetString("PASSWORD_MUST_BE_GREATER_THAN_EIGHT", resourceCulture);
            }
        }
